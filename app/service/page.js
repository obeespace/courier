  ...
  return (
    <main>
      ...
      <section className="py-20">
        <div className="container w-11/12 lg:w-5/6 mx-auto">
          <div className="text-center space-y-4 mb-16 w-11/12 mx-auto">
            <h2 className="text-3xl lg:text-4xl font-bold">
              Our Core Services
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Professional delivery solutions designed for businesses and
              individuals
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 mb-16">
            ...
            <div className="hover:shadow-lg transition-shadow p-9 bg-gradient-to-br from-purple-50 via-gray-50 to-[#e0e7ff] rounded-2xl">
              ...
              <p className="text-base mb-3">
                Ultra-fast delivery service for urgent packages within the same
                city
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="pt-4 border-t">
                  <div className="md:flex items-center justify-between">
                    ...
                    <button className="mt-3 md:mt-0 rounded-lg py-2 px-4 border hover:bg-purple-900 hover:text-white border-purple-900 shadow-md text-purple-900">Get Quote</button>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="hover:shadow-lg shadow-sm transition-shadow p-9 border border-gray-300 rounded-2xl">
              ...
              <div className="mt-4">
                ...
                <div className="md:flex items-center justify-between">
                  <p className="font-semibold text-primary">From $45</p>
                  <button className="mt-3 md:mt-0 rounded-lg py-2 px-4 border hover:bg-purple-900 hover:text-white border-purple-900 shadow-md text-purple-900">Get Quote</button>
                </div>
              </div>
            </div>
            ...
            <div className="hover:shadow-lg shadow-sm transition-shadow p-9 border border-gray-300 rounded-2xl">
              ...
              <div className="mt-4">
                ...
                <div className="md:flex items-center justify-between">
                  <p className="font-semibold text-primary">From $75</p>
                  <button className="mt-3 md:mt-0 rounded-lg py-2 px-4 border hover:bg-purple-900 hover:text-white border-purple-900 shadow-md text-purple-900">Get Quote</button>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-muted/30">
        <div className="container w-5/6 md:w-11/12 mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="pt-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Temperature-controlled transport for medical supplies and
                  pharmaceuticals
                </p>
            ...
            <div className="text-center">
              <div className="pt-6">
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Direct airport pickup and delivery for time-sensitive
                  shipments
                </p>
                <button className="rounded-lg py-2 px-4 border hover:bg-purple-900 hover:text-white border-purple-900 shadow-md text-purple-900">
                  Learn More
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-muted-foreground text-lg">
                We provide comprehensive delivery services across multiple
                regions with expanding coverage areas.
              </p>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      All 50 US states and major Canadian cities
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      200+ countries with trusted local partners
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center space-y-8">
            ...
            <p className="text-xl text-muted-foreground">
              Use our pricing calculator to get accurate quotes for your
              specific delivery needs in seconds.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <div className="flex justify-center">
                <button className="flex items-center rounded-lg w-fit py-2 px-4 cursor-pointer bg-purple-900 shadow-md text-white">
                  <PiCalculator className="mr-2 h-5 w-5" />
                  Calculate Price
                </button>
              </div>
              <div className="flex justify-center">
                <button className="rounded-lg py-2 px-4 w-fit bg-white text-purple-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="pt-8">
                ...
                <p className="text-muted-foreground mb-3">
                  99.9% on-time delivery rate with money-back guarantee for
                  express services
                </p>
            ...
            <div className="text-center">
              <div className="pt-8">
                ...
                <p className="text-muted-foreground mb-3">
                  Full insurance coverage and secure handling for all packages
            ...
            <div className="text-center">
              <div className="pt-8">
                ...
                <p className="text-muted-foreground mb-3">
                  Round-the-clock customer support with dedicated account
                  managers for business clients
                </p>
                <div className="flex items-center justify-center gap-1">
                  {[...Array(5)].map((_, i) => (
                    <FaStar
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container text-center space-y-8">
          <h2 className="text-3xl lg:text-4xl font-bold">
            Ready to Ship with SwiftCourier?
          </h2>
          <p className="text-xl opacity-90 max-w-2xl mx-auto">
            Choose the service that fits your needs and experience the
            SwiftCourier difference today.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <div className="flex justify-center">
            <button className="flex items-center rounded-lg py-2 px-4 cursor-pointer bg-purple-900 shadow-md text-white">
            ...
            <div className="flex justify-center">
            <button className="flex items-center rounded-lg py-2 px-4 cursor-pointer border border-purple-900 shadow-md text-purple-900 hover:bg-purple-900 hover:text-white">
