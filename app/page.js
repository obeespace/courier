          ...
          <div className="container">
            <div className="text-center space-y-4 mb-16">
              ...
              <p className="text-muted-foreground max-w-2xl mx-auto">
                SnappiGo was born from a simple idea: delivery services should
                be fast, reliable, and accessible to everyone.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 text-sm">
              <div className="text-center">
                ...
                <p className="text-muted-foreground w-11/12 mx-auto mt-2">
                  Find the best products without the hassle. Our sourcing
                  experts carefully screen suppliers, secure competitive prices,
                  and handle delivery schedules — freeing you up to focus on
                  growing your business with complete peace of mind.
                </p>
              </div>
              ...
              <div className="text-center mt-10 md:mt-0">
                ...
                <p className="text-muted-foreground w-11/12 mx-auto mt-2">
                  ...
                  challenges. We put your needs first, offering flexible,
                  tailored solutions backed by a commitment to reliability and
                  exceptional service.
                </p>
              </div>
              ...
              <div className="text-center mt-10 md:mt-0">
                ...
                <p className="text-muted-foreground w-11/12 mx-auto mt-2">
                  ...
                  greater efficiency, and more time for you to drive your
                  business forward.
                </p>
              </div>
            </div>
